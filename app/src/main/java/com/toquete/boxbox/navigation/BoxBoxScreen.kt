...
import com.toquete.boxbox.feature.raceresults.R as raceResultsR
import com.toquete.boxbox.feature.races.R as racesR

enum class BoxBoxScreen(val route: String, @StringRes val titleTextId: Int) {
    STANDINGS(route = STANDINGS_ROUTE, titleTextId = R.string.app_name),
    RACES(route = RACES_ROUTE, titleTextId = racesR.string.races),
    RACE_RESULTS(route = RACE_RESULT_ROUTE, titleTextId = raceResultsR.string.race_results)
}
